...
public class Cell extends JPanel implements MouseListener{
	...
	//Constructors
	public Cell(int x,int y,Figure p)
	{		
		this.x=x;
		this.y=y;
	...
	public void setPiece(Figure p)    //Function to inflate a cell with a piece
	{
		piece=p;
	...
	public Figure getpiece()    //Function to access piece of a particular cell
	{
		return this.piece;
	}
